...
export const partitionStories = [
  {
    id: 'lahore-family',
    name: 'A family from Lahore',
    age: 'Illustrative account',
    from: 'Lahore',
    to: 'Lahore (stayed)',
    journey:
  ...
  {
    id: 'amritsar-crossing',
    name: 'A young couple, newly married',
    age: 'Illustrative account',
    from: 'Amritsar',
    to: 'Lahore',
    journey:
  ...
  {
    id: 'railway-child',
    name: 'A child, travelling alone with an uncle',
    age: 'Illustrative account, roughly age 9',
    from: 'Jalandhar',
    to: 'Karachi',
    journey:
