export const buildChallenges = {
  ...
  ai: {
    ...
    idea: 'Build an AI-powered assistant fine-tuned on Pakistani languages for education and customer support.',
    technology: 'Fine-tuned open-source LLMs, Urdu speech-to-text, and a simple chat interface.',
    impact: 'Students and small businesses get help in the language they actually think in.',
  },
  healthcare: {
    problem: 'Rural clinics often have no specialist within a two-hour drive.',
    idea: 'Build a telemedicine platform connecting village health workers directly to city specialists via low-bandwidth video.',
    technology: 'WebRTC for video, an offline patient-record app, and SMS-based appointment reminders.',
    impact: 'A single specialist can now meaningfully serve dozens of villages instead of one clinic.',
  },
  education: {
    problem: 'Millions of children have phones but no structured way to catch up on missed schooling.',
    idea: 'Build a bite-sized, offline-downloadable learning app aligned with the national curriculum.',
    technology: 'Progressive Web App with offline caching, and short-form video lessons.',
    impact: 'A student without reliable internet can still learn a full grade\'s curriculum on one download.',
  },
  business: {
    problem: 'Freelancers and small exporters struggle with international payments and invoicing.',
    idea: 'Build a fintech tool that simplifies cross-border invoicing and currency conversion for freelancers.',
    technology: 'Payment gateway APIs, automated tax-ready invoice generation, and a mobile dashboard.',
    impact: 'Freelancers spend less time on paperwork and more time on billable work.',
  },
  environment: {
